 ...
 * {@code qname.getLocalPart()} was incorrectly used as the namespace prefix instead of {@code
 * qname.getPrefix()}. This produced redundant namespace declarations where the attribute name was
