...
public class TestGetRole extends TestCase {
    ...
    protected void runTest() throws Throwable {
        ...
        assertThat(soapHeaderBlock.getRole()).as("SOAP HeaderBlock Test : - After creating SOAPHeaderBlock, it has a role").isNull();
