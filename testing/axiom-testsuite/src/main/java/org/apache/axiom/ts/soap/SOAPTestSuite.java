        ...
        return new InjectorNode(
                ...
                new ParentNode(
                        ...
                        new FanOutNode<>(
                                ...
                                new InjectorNode(new SOAPFactoryModule(), specTests())),
                        ...
                        new FanOutNode<>(
                                ...
                                LabelBinding.simpleString("message", SOAPSample::getName),
                                new InjectorNode(
                                        ImmutableList.of(
                                                new AbstractModule() {
                                                    @Provides
                                                    SOAPSpec provideSOAPSpec(SOAPSample sample) {
                                                        return sample.getSOAPSpec();
                                                    }
                                                },
