 ...
 */
public class TestName3Unqualified implements Executable {
    @Inject
    ...
    public void execute() throws Throwable {
        ...
        OMNamespace ns = factory.createOMNamespace("http://DUMMYNS", "DUMMYPREFIX");
        OMElement element =
                factory.createOMElement(new PullOMDataSource(TestDocument.DOCUMENT3.getContent()), "DUMMYNAME", ns);
        ...
        assertThat(element.getNamespace().getNamespaceURI()).isEmpty();
