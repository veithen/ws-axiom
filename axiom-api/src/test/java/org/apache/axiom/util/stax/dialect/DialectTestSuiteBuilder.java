    ...
    protected void addTests() {
        Injector injector =
                Guice.createInjector(
                        new MultitonModule<>(StAXImplementation.class),
                        new MultitonModule<>(StreamType.class));
        for (StAXImplementation impl :
                injector.getInstance(Key.get(new TypeLiteral<Set<StAXImplementation>>() {}))) {
            StAXImplementationAdapter staxImpl = impl.getAdapter(StAXImplementationAdapter.class);
            ...
            addTest(
                    new TestGetEncodingFromDetection(
                            staxImpl, "UnicodeLittle", "UTF-16", "UTF-16LE"));
            ...
            addTest(
                    new TestGetEncodingFromDetection(
                            staxImpl, "UnicodeLittleUnmarked", "UTF-16LE"));
            ...
            addTest(
                    new TestIsCharacters(
                            staxImpl, XMLStreamConstants.PROCESSING_INSTRUCTION, false));
