    ...
    Stream<DynamicNode> tests() {
        return W3CDOMLevel1TestSuite.create(DOMTests.FACTORY, DOMTests.UNSUPPORTED_FEATURES)
                .toDynamicNodes(MatrixTestFilters.builder()
                        .add("(id=http://www.w3.org/2001/DOM-Test-Suite/level1/core/attrspecifiedvalueremove)")
                        .add("(id=http://www.w3.org/2001/DOM-Test-Suite/level1/core/documentcreateelementdefaultattr)")
                        .add(
                        ...
                        .add("(id=http://www.w3.org/2001/DOM-Test-Suite/level1/core/elementremoveattribute)")
                        .add(
                        ...
                        .add("(id=http://www.w3.org/2001/DOM-Test-Suite/level1/core/namednodemapremovenameditem)")
                        .add(
                        ...
                        .add("(id=http://www.w3.org/2001/DOM-Test-Suite/level1/core/hc_elementnormalize)")
                        .add("(id=http://www.w3.org/2001/DOM-Test-Suite/level1/core/hc_elementnormalize2)")
